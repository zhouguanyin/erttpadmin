...
class CustomerOrdersGoodsTemporaryModel extends BaseModel
{
    protected $name = 'customer_orders_goods_temporary';
    ...
    public static function getListByCond($params)
    {
        ...
        if(!empty($key['goods_name'])){
            $where['goods_name'] = ['like','%'.$key['goods_name'].'%'];
        }
        if(!empty($key['nums'])){
